    ...
    <section className="relative">
      ...
      <div className="container mx-auto px-4 flex flex-col items-center py-12 md:py-20">
        <div className="relative w-full max-w-5xl">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-linear-to-r from-orange-500/20 via-pink-500/20 to-purple-500/20 blur-[120px] -z-10 rounded-full" />
