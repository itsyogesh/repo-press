  ...
  try {
    return (
      <div className="repo-jsx-container relative group">
        <div className="absolute -top-6 left-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 bg-studio-accent text-studio-accent-fg text-[10px] font-medium px-1.5 py-0.5 rounded-t-sm pointer-events-none z-20">
