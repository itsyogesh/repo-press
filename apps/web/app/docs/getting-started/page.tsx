...
export default function GettingStartedPage() {
  return (
    <div>
      <h1 className="rp-display mb-6 text-3xl md:text-4xl">Getting Started</h1>
      ...
      {/* Prerequisites */}
      <h2 className="rp-display text-2xl mb-4 mt-12">Prerequisites</h2>
      ...
      {/* Step 1 */}
      <h2 className="rp-display text-2xl mb-4 mt-12">Step 1: Sign In</h2>
      <p className="mb-4 leading-relaxed text-muted-foreground">
        Visit{" "}
      ...
      {/* Step 2 */}
      <h2 className="rp-display text-2xl mb-4 mt-12">Step 2: Select Your Repository</h2>
      <p className="mb-4 leading-relaxed text-muted-foreground">
      ...
      {/* Step 3 */}
      <h2 className="rp-display text-2xl mb-4 mt-12">Step 3: Create a Project</h2>
      <p className="mb-4 leading-relaxed text-muted-foreground">
      ...
      {/* Step 4 */}
      <h2 className="rp-display text-2xl mb-4 mt-12">Step 4: Open the Studio</h2>
      <p className="mb-4 leading-relaxed text-muted-foreground">
      ...
      {/* Step 5 */}
      <h2 className="rp-display text-2xl mb-4 mt-12">Step 5: Start Editing</h2>
      <p className="mb-4 leading-relaxed text-muted-foreground">
      ...
      {/* What's Next */}
      <h2 className="rp-display text-2xl mb-4 mt-12">What&rsquo;s Next?</h2>
      <ul className="mb-4 list-inside list-disc space-y-2 text-muted-foreground">
        <li>
          Learn{" "}
